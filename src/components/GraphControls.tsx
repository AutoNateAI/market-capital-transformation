    ...
    <div className="p-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <Card className="bg-slate-800/50 border-slate-700">
        <CardHeader className="pb-3">
          <CardTitle className="text-white text-base md:text-lg">Network Stats</CardTitle>
        </CardHeader>
      ...
      <Card className="bg-slate-800/50 border-slate-700">
        <CardHeader className="pb-3">
          <CardTitle className="text-white text-base md:text-lg">Network Controls</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3 md:space-y-4">
          <div className="grid grid-cols-1 gap-2 md:space-y-2 md:grid-cols-1">
            <Button 
              variant="outline" 
      ...
      <Card className="bg-slate-800/50 border-slate-700">
        <CardHeader className="pb-3">
          <CardTitle className="text-white text-base md:text-lg">Distance Controls</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3 md:space-y-4">
          {Object.entries(distanceSettings).map(([type, value]) => (
            <div key={type} className="space-y-2">
              <div className="flex justify-between items-center">
                <label className="text-slate-300 text-xs md:text-sm capitalize">
                  {type.replace('-', ' ')}
                </label>
                <span className="text-blue-300 text-xs md:text-sm">{value}</span>
              </div>
              <Slider
                value={[value]}
      ...
      {isTraversalMode && (
        <Card className="bg-blue-900/30 border-blue-600">
          <CardHeader className="pb-3">
            <CardTitle className="text-blue-300 text-base md:text-lg">Path Builder</CardTitle>
          </CardHeader>
          <CardContent>
